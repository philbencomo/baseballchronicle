...
function mtFetchUser(cb) {
    ...
    if ( ( cb == 'mtSetUser' ) && mtGetUser() ) {
        ...
        script.src = 'http://thebaseballchronicle.com/cgi-bin/mt/mt-comments.cgi?__mode=session_js&blog_id=7&jsonp=' + cb + '&ts=' + ts;
...
function mtSignIn() {
    ...
    var url = 'http://thebaseballchronicle.com/cgi-bin/mt/mt-comments.cgi?__mode=login&blog_id=7';
    if (is_preview) {
