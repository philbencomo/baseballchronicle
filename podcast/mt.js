...
function mtFetchUser(cb) {
    ...
    if ( ( cb == 'mtSetUser' ) && mtGetUser() ) {
        ...
        script.src = 'https://thebaseballchronicle.com/cgi-bin/mt/mt-comments.cgi?__mode=session_js&blog_id=7&jsonp=' + cb + '&ts=' + ts;
...
function mtCommentOnSubmit(f) {
    if (!mtRequestSubmitted) {
        ...
        if (f.armor)
            f.armor.value = '8ba46885f4434bda6ebf5ade2435045c5f895deb';
...
function mtSignIn() {
    ...
    var url = 'https://thebaseballchronicle.com/cgi-bin/mt/mt-comments.cgi?__mode=login&blog_id=7';
    if (is_preview) {
        if ( document['comments_form'] ) {
            var entry_id = document['comments_form'].entry_id.value;
            url += '&entry_id=' + entry_id;
        } else {
            url += '&return_url=http%3A%2F%2Fthebaseballchronicle.com%2Fpodcast%2F';
        }
    } else {
