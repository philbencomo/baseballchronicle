...
var mtCookieName = "mt_blog5_user";
var mtCookieDomain = ".thebaseballchronicle.com";
var mtCookiePath = "/notes/";
...
function mtCommentOnSubmit(f) {
    if (!mtRequestSubmitted) {
        ...
        if (f.armor)
            f.armor.value = 'bdf182eb06a75b57afe13c13a4494b2219fec8af';
...
function mtSignIn() {
    ...
    if (is_preview) {
        if ( document['comments_form'] ) {
            ...
            url += '&return_url=http%3A%2F%2Fthebaseballchronicle.com%2Fnotes%2F';
        }
    } else {
